...
public partial class TeamLeaderReportListView
{
    ...
    private async Task LoadData()
    {
        ...
        reports = allReports.Where(r => !string.IsNullOrEmpty(r.User_Evaluation_4) && string.IsNullOrEmpty(r.TeamLeader_Evaluation_4)).ToList();
    }

    private void HandleEdit(long rid)
    {
        NavigationManager.NavigateTo($"/report/teamleader/edit/{rid}");
    }
    #endregion
}

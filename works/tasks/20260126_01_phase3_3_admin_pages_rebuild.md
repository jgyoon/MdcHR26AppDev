...
<h4>사용자 관리</h4>
<button class="btn btn-link" @onclick="urlActions.MoveUserManagePage">사용자 관리</button>

<h4>기초정보 관리</h4>
<button class="btn btn-link" @onclick="urlActions.MoveSettingManagePage">기초정보 관리</button>

<h4>평가대상자 관리</h4>
<button class="btn btn-link" @onclick="urlActions.MoveEUserManagePage">평가대상자 관리</button>
```

**또는 링크 스타일**:
```razor
<a href="javascript:void(0)" @onclick="urlActions.MoveUserManagePage">사용자 관리</a>
```

**중요**: 하드코딩된 `<a href="/Admin/...">` 사용 금지!

**빌드 테스트**: `dotnet build`

---

### Step 4: 사용자 관리 - UserManage.razor (목록)
...
### Step 8: 사용자 관리 - Details.razor (상세)
...
### Step 9: 기초정보 관리 통합 페이지 (SettingManage.razor)
...
### Step 10: 기초정보 - 부서 관리 CRUD (Settings/Dept/)
...
### Step 11: 기초정보 - 직급 관리 CRUD (Settings/Rank/)
...
### Step 12: 평가대상자 관리 (EvaluationUsers/)
...
- [ ] Step 1: UrlActions 메서드 추가 및 빌드 성공
- [ ] Step 2: UserUtils 생성 및 빌드 성공
- [ ] Step 3: Admin Index.razor 복사 및 수정 (SettingManage 링크)
- [ ] Step 4: UserManage.razor 복사 및 수정 (ERank 필드 사용)
- [ ] Step 5: Users/Create.razor 복사 및 수정 (순차적 생성 로직)
- [ ] Step 6: Users/Edit.razor 복사 및 수정
- [ ] Step 7: Users/Delete.razor 복사 및 빌드 성공
- [ ] Step 8: Users/Details.razor 복사 및 빌드 성공
- [ ] Step 9: SettingManage.razor 생성 (탭 방식 통합 페이지)
- [ ] Step 10: Settings/Dept/ 복사 및 빌드 성공 (경로 변경)
- [ ] Step 11: Settings/Rank/ 생성 및 빌드 성공
- [ ] Step 12: EvaluationUsers/ 복사 및 수정
- [ ] 전체 빌드 성공 (오류 0개)
